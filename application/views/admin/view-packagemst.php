               ...
               <tbody>
                ...
                foreach ($data as $key => $value) { ?>
                  <tr>
                     ...
                     <td><a href="<?=ADMINURL.'Add_packagemst?id='.md5($value['id'])?>">
                             <span class="label label-success"><span class="glyphicon glyphicon-edit"></span></span></a>
                             <a href="<?=ADMINURL.'Add_packagemst/delete?id='.md5($value['id'])?>"><span class="label label-danger"><span class=" glyphicon glyphicon-remove"></span></span></a></td>
                  </tr>
                   <?php $n++; } }?>
               </tbody>
            </table>
