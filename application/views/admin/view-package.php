            ...
            <table cellpadding="0" cellspacing="0" width="100%" class="table" id="tSortable">
               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td><img src="<?=IMGURL.$value['image'];?>" height="75px"></td>
                     ...
                     <td><a href="<?=ADMINURL.'Add_package?id='.md5($value['id'])?>">
                             <span class="label label-success"><span class="glyphicon glyphicon-pencil"></span></span></a>
                     <a href="<?=ADMINURL.'Add_package/delete?id='.md5($value['id'])?>"><span class="label label-danger"><span class="glyphicon glyphicon-trash glyphicon glyphicon-white"></span></span></a></td>
                  </tr>
                  <?php $n++; } }?>
               </tbody>
            </table>
