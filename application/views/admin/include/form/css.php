    ...
    <script type='text/javascript' src='<?=ADMINASSESTS;?>js/plugins/multiselect/jquery.multi-select.js'></script>
    <script type='text/javascript' src='<?=ADMINASSESTS;?>js/plugins/tagsinput/jquery.tagsinput.min.js'></script>
    ...
    <script type='text/javascript' src='<?=ADMINASSESTS;?>js/settings.js'></script>
